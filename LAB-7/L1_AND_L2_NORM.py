...
def cost_function(h,y,th):
    lam=0.1
    c_f=[]
    for x,y1 in zip(h,y):
        c_f.append((x-y1)**2)
    return (sum(c_f)/2)+l1_reg(th,lam)
...
# lam=0.1
# print(l2_reg([1,2,3,4,5,6,7,8],lam))    #simulating the l1 and l2 norm.
# print(l1_reg([1,2,3,4,5,6,7,8],lam))
